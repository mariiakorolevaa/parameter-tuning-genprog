...
population_size, elitism_size = generate_valid_population_and_elitism(population_size_bounds, elitism_size_bounds)

print("Generated Population Size:", population_size)
print("Generated Elitism Size:", elitism_size)
